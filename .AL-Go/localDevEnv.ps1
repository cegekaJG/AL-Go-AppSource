...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/publish-testmaster/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/publish-testmaster/AL-Go-Helper.ps1'
